	...
	cases := []struct {
		...
		},
		{
			...
			event: storage.Event{
				...
				StartTime:    time.Date(2025, 6, 18, 10, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 6, 18, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
		...
		},
		{
			...
			event: storage.Event{
				ID:           "test1",
				Title:        "Простое событие",
				StartTime:    time.Date(2025, 6, 20, 10, 0, 0, 0, time.UTC),
		...
		},
		{
			...
			event: storage.Event{
				...
				StartTime:    time.Date(2025, 5, 18, 10, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 5, 18, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
		},
		{
			...
			event: storage.Event{
				...
				StartTime:    time.Date(2025, 5, 19, 10, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 5, 19, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       2,
				NotifyBefore: 2 * time.Hour,
			},
		...
		{
			name: "add with exist same data",
			event: storage.Event{
				ID:           "test5",
				Title:        "Простое событие 5",
				StartTime:    time.Date(2025, 5, 19, 10, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 5, 19, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
			...
			expectedErr: storage.ErrDateBusy,
		},
		{
			name: "add with exist start before end",
			event: storage.Event{
				ID:           "test6",
				Title:        "Простое событие 6",
				StartTime:    time.Date(2025, 5, 19, 11, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 5, 19, 13, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
		...
		{
			name: "add with exist end before start",
			event: storage.Event{
				ID:           "test7",
				Title:        "Простое событие 7",
				StartTime:    time.Date(2025, 5, 19, 9, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 5, 19, 11, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
		...
		{
			name: "add with exist start before start and end after end",
			event: storage.Event{
				ID:           "test7",
				Title:        "Простое событие 7",
				StartTime:    time.Date(2025, 5, 19, 9, 0, 0, 0, time.UTC),
	...
	changeCases := []struct {
	...
	}{
		{
			...
			event: storage.Event{
				...
				EndTime:      time.Date(2025, 6, 17, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
		...
		{
			name: "change to busy date",
			event: storage.Event{
				ID:           "event1",
				Title:        "Простое измененное событие",
				StartTime:    time.Date(2025, 6, 16, 9, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 6, 16, 11, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
		...
		},
		{
			...
			event: storage.Event{
				ID:           "not exist",
				Title:        "Простое событие",
				StartTime:    time.Date(2025, 10, 17, 10, 0, 0, 0, time.UTC),
				EndTime:      time.Date(2025, 10, 17, 12, 0, 0, 0, time.UTC),
				Description:  "",
				UserID:       1,
				NotifyBefore: 2 * time.Hour,
			},
...
func setupTestStorage(t *testing.T) *Storage {
	...
	events := []storage.Event{
		...
		},
		{
			...
			EndTime:      time.Date(2025, 6, 16, 12, 0, 0, 0, time.UTC),
			Description:  "",
			UserID:       1,
			NotifyBefore: 2 * time.Hour,
		},
		...
		},
		{
			...
			EndTime:      time.Date(2025, 6, 16, 14, 0, 0, 0, time.UTC),
			Description:  "",
			UserID:       2,
			NotifyBefore: 2 * time.Hour,
		},
